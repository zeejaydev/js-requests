...
/*
    ...
    Inside the callback function, console.log the response's data (in the intermediate 
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/zaid').then((resp)=>{
        document.getElementById('repeat-text').textContent = resp.data
...
// CODE HERE
const query = ()=>{
    axios.get('http://localhost:3000/query-test?name:zaid&age:30').then(resp=>console.log(resp.data))
}
...
/*
    ...
    got a message saying "You sent an empty query!"
...
const createFood = (e)=>{
    ...
    axios.post('http://localhost:3000/food', body).then(resp=>{
